(function() {
    window.Wheel = {
        ...
        prepare: function(wheel, winner) {
            ...
            var tiles = Wheel.tilesPerFrame(currentWheel);
        ...
        add: function(wheel) {
            ...
            newWheel.setAttribute('id', 'wheel' + wheel);
            newWheel.className = 'wheel';
            ...
            Wheel.wheels[wheel] = {
                ...
                nextTrack: null,
                scroll: 0,
                container: document.getElementById('wheel' + wheel)
            };
        },
        ...
        init: function(id, options) {
            ...
            Wheel.options.items =  options.itemCount || 28 + Math.ceil(Wheel.tilesPerFrame(Wheel) / 2);
